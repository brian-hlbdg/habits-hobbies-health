    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      >
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-400 mt-0.5">{completed}/{total} tasks done</p>
        </div>
              ...
              {adding ? (
                <form onSubmit={handleAddTask} className="flex gap-2 pt-1">
                  <input
                    ...
                    className="flex-1 rounded-lg border border-gray-200 px-3 py-1.5 text-sm outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
                  />
                  <button
                    type="submit"
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-emerald-600 transition pt-1"
                >
    ...
    <div className="max-w-xl mx-auto px-4 pt-6 pb-28">
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Home projects & multi-step tasks</p>
        </div>
        <button
