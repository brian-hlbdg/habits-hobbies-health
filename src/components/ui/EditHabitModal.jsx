...
export default function EditHabitModal({ habit, onSave, onClose }) {
  ...
  const [category, setCategory]   = useState(habit.category || 'daily')
  const [context, setContext]     = useState(habit.context || 'home')
  ...
  function handleSubmit(e) {
    ...
    onSave(habit.id, {
      ...
      context,
      frequency,
      view:      frequency,  // view mirrors frequency for habits
    })
    onClose()
  }
    ...
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center">
      ...
      <div className="relative w-full max-w-lg bg-white dark:bg-zinc-900 rounded-t-2xl md:rounded-2xl p-5 slide-up shadow-xl">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-semibold text-gray-800 dark:text-zinc-100">Edit habit</h3>
