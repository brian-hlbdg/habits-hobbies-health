...
export default function CategorySection({ category, items, onToggle, onNoteClick, onDueDateClick }) {
  ...
  const cardClass = [
    ...
    catUrgency ? urgencyCategoryClasses[catUrgency] : 'bg-white border-gray-200',
  ].join(' ')
  ...
  return (
    <div className={cardClass}>
      ...
      >
        ...
        <svg
          className={`w-4 h-4 text-gray-400 ml-3 flex-shrink-0 transition-transform ${open ? '' : '-rotate-90'}`}
